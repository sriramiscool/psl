...
public class LinearLossTermTest {
    ...
    public void testReadWrite() throws IOException {
        ...
        LinearLossTerm term = new LinearLossTerm(new Hyperplane<LocalVariable>(variables, coeffs, constant, z.length), wInd);
        ...
        LinearLossTerm term1 = new LinearLossTerm(new Hyperplane<LocalVariable>(variables1, coeffs1, constant1, z1.length), wInd1);

        Assert.assertEquals((Float.SIZE*2 + Integer.SIZE * 4) / 8, term.fixedByteSize()); // 2 coeff + ruleIndex + 2 globalId + size
    ...
    public void testReadWrite2() throws IOException {
        ...
        Assert.assertEquals((Float.SIZE*1 + Integer.SIZE * 3) / 8, term1.fixedByteSize()); // 1 coeff + ruleIndex + 1 globalId + size
