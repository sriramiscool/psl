...
public class HingeLossTermTest {
    ...
    public void testReadWrite() throws IOException {
        ...
        HingeLossTerm term = new HingeLossTerm(new Hyperplane<LocalVariable>(variables, coeffs, constant, z.length), wInd);
        ...
        HingeLossTerm term1 = new HingeLossTerm(new Hyperplane<LocalVariable>(variables1, coeffs1, constant1, z1.length), wInd1);
    ...
    private void testProblem(float[] z, float[] y, float[] coeffs, float constant,
        ...
        HingeLossTerm term = new HingeLossTerm(new Hyperplane<LocalVariable>(variables, coeffs, constant, z.length), 0);
